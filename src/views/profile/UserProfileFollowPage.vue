<template>
    <div>
      <div class="collection-option-div">
        <span class="goto-left-span" @click="goback()"><i class="fa fa-arrow-left" aria-hidden="true"></i></span>
        <router-link to="myFollower" class="collection-link">我的关注</router-link>
        <router-link to="myFans" class="collection-link">我的粉丝</router-link>
      </div>
      <div>
