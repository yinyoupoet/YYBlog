!function (t) {
  ...
  function $(t, e, i) {
    ...
    var _ = 360 - r(i.left - t.x, -1 * (i.top - t.y)), a = 360 - r(i.left - t.x, -1 * (i.top + i.height - t.y)),
      $ = r(i.left + i.width - t.x, -1 * (i.top - t.y)), u = r(i.left + i.width - t.x, -1 * (i.top + i.height - t.y)),
      p = n / o, f = {};
    if (s < $) {
  ...
  function u(t) {
    ...
    var e = D.getBoundingClientRect(), i = P(t.clientX - e.left), r = S(t.clientY - e.top),
      o = $({x: e.left + e.width / 2, y: e.top + e.height * G}, {x: t.clientX, y: t.clientY}, e), n = m(o.x - e.left),
      s = T(o.y - e.top);
  ...
  (function (t) {
    !function () {
      ...
      e._$0s = 1, e._$4s = 2, e._$42 = 0, e._$62 = function (t, i) {
        ...
        if (i > 0) {
          ...
          for (r = 0; r < this.clipContextList.length; r++) {
            var _ = (o = this.clipContextList[r]).allClippedDrawRect, a = (o.layoutChannelNo, o.layoutBounds);
        ...
        var r, o, n = -Math.atan2(this.p1.y - this.p2.y, this.p1.x - this.p2.x), s = Math.cos(n), _ = Math.sin(n),
          a = 9.8 * this.p2._$p, h = this._$Db * Pt._$bS, l = a * Math.cos(n - h);
        r = l * _, o = l * s;
      ...
      Lt._$ni = function (t, e, i, r, o, n, s, _, a) {
        ...
        if (3 == o) {
          var $ = r[n[0]], u = r[n[1]], p = r[n[2]], f = r[n[3]], c = r[n[4]], d = r[n[5]], g = r[n[6]], y = r[n[7]];
          return (B = (_ = $ + (u - $) * (b = s[0]) | 0) + ((a = p + (f - p) * b | 0) - _) * (C = s[1]) | 0) + ((U = (h = c + (d - c) * b | 0) + ((l = g + (y - g) * b | 0) - h) * C | 0) - B) * (N = s[2]) | 0
        }
        if (4 == o) {
          var m = r[n[0]], T = r[n[1]], P = r[n[2]], S = r[n[3]], v = r[n[4]], L = r[n[5]], E = r[n[6]], M = r[n[7]],
            I = r[n[8]], A = r[n[9]], w = r[n[10]], x = r[n[11]], O = r[n[12]], D = r[n[13]], R = r[n[14]],
            F = r[n[15]], b = s[0], C = s[1], N = s[2],
        ...
        if (3 == o) {
          var u = r[n[0]], p = r[n[1]], f = r[n[2]], c = r[n[3]], d = r[n[4]], g = r[n[5]], y = r[n[6]], m = r[n[7]],
            $ = s[0], T = s[1];
          return (1 - (N = s[2])) * ((1 - T) * (u + (p - u) * $) + T * (f + (c - f) * $)) + N * ((1 - T) * (d + (g - d) * $) + T * (y + (m - y) * $))
        }
        if (4 == o) {
          var P = r[n[0]], S = r[n[1]], v = r[n[2]], L = r[n[3]], E = r[n[4]], M = r[n[5]], I = r[n[6]], A = r[n[7]],
            w = r[n[8]], x = r[n[9]], O = r[n[10]], D = r[n[11]], R = r[n[12]], F = r[n[13]], b = r[n[14]],
            C = r[n[15]], $ = s[0], T = s[1], N = s[2], B = s[3];
      ...
      Et.STATE_FIRST = "STATE_FIRST", Et.STATE_INTERVAL = "STATE_INTERVAL", Et.STATE_CLOSING = "STATE_CLOSING", Et.STATE_CLOSED = "STATE_CLOSED", Et.STATE_OPENING = "STATE_OPENING", V.prototype = new E, V._$As = 32, V._$Gr = !1, V._$NT = null, V._$vS = null, V._$no = null, V._$9r = function (t) {
        ...
        if (this._$GS._$Ur(t)) {
          ...
          if (this._$GS._$zr(n, s, o), o <= 0) {
            ...
            var c = this._$Y0[n[0]], d = this._$Y0[n[1]], g = this._$Y0[n[2]], y = this._$Y0[n[3]], m = this._$Y0[n[4]],
              ...
              L = m._$fL + (T._$fL - m._$fL) * h, E = P._$fL + (S._$fL - P._$fL) * h;
            ...
            var M = this._$Y0[n[0]], I = this._$Y0[n[1]], A = this._$Y0[n[2]], w = this._$Y0[n[3]], x = this._$Y0[n[4]],
              O = this._$Y0[n[5]], D = this._$Y0[n[6]], R = this._$Y0[n[7]], F = this._$Y0[n[8]], b = this._$Y0[n[9]],
              ...
              p = M._$fL + (I._$fL - M._$fL) * h, f = A._$fL + (w._$fL - A._$fL) * h,
              L = x._$fL + (O._$fL - x._$fL) * h, E = D._$fL + (R._$fL - D._$fL) * h,
              V = F._$fL + (b._$fL - F._$fL) * h, z = C._$fL + (N._$fL - C._$fL) * h,
        ...
        for (var o = (e - r._$z2) * this._$D0 / 1e3, n = 0 | o, s = o - n, _ = 0; _ < this.motions.length; _++) {
          ...
          if (a._$RP == N._$hs) {
            ...
            var u, p = t.getParamIndex(l), f = t.getModelContext(), c = .4 * (f.getParamMax(p) - f.getParamMin(p)),
              d = f.getParamFloat(p), g = a._$I0[n >= h ? h - 1 : n], y = a._$I0[n + 1 >= h ? h - 1 : n + 1],
        ...
        for (var h, l, $, u = r * n, p = 0, f = 0, c = 0, d = 0, g = 0, y = 0, m = !1, T = o; T < u; T += n) {
          ...
          if (v = e[T], L = e[T + 1], P = v * _, S = L * a, P < 0 || S < 0 || _ <= P || a <= S) {
            ...
            if (!m) {
              ...
              var M = s[2 * (_ + a * E)] - s[2 * (0 + 0 * E)], I = s[2 * (_ + a * E) + 1] - s[2 * (0 + 0 * E) + 1],
                A = s[2 * (_ + 0 * E)] - s[2 * (0 + a * E)], w = s[2 * (_ + 0 * E) + 1] - s[2 * (0 + a * E) + 1];
              p -= .5 * ((c = .5 * (M + A)) + (g = .5 * (M - A))), f -= .5 * ((d = .5 * (I + w)) + (y = .5 * (I - w)))
            }
            if (-2 < v && v < 3 && -2 < L && L < 3) if (v <= 0) if (L <= 0) {
              var x = s[2 * (0 + 0 * E)], O = s[2 * (0 + 0 * E) + 1], D = p - 2 * c, R = f - 2 * d, F = p - 2 * g,
                b = f - 2 * y, C = p - 2 * c - 2 * g, N = f - 2 * d - 2 * y;
              (B = .5 * (v - -2)) + (U = .5 * (L - -2)) <= 1 ? (i[T] = C + (F - C) * B + (D - C) * U, i[T + 1] = N + (b - N) * B + (R - N) * U) : (i[T] = x + (D - x) * (1 - B) + (F - x) * (1 - U), i[T + 1] = O + (R - O) * (1 - B) + (b - O) * (1 - U))
            } else if (L >= 1) {
              var F = s[2 * (0 + a * E)], b = s[2 * (0 + a * E) + 1], C = p - 2 * c + 1 * g, N = f - 2 * d + 1 * y,
                x = p + 3 * g, O = f + 3 * y, D = p - 2 * c + 3 * g, R = f - 2 * d + 3 * y;
              ...
              var B = .5 * (v - -2), U = S - k, G = k / a, Y = (k + 1) / a, F = s[2 * (0 + k * E)],
                b = s[2 * (0 + k * E) + 1], x = s[2 * (0 + (k + 1) * E)], O = s[2 * (0 + (k + 1) * E) + 1],
                C = p - 2 * c + G * g, N = f - 2 * d + G * y, D = p - 2 * c + Y * g, R = f - 2 * d + Y * y;
              ...
              var B = .5 * (v - 1), U = S - k, G = k / a, Y = (k + 1) / a, C = s[2 * (_ + k * E)],
                N = s[2 * (_ + k * E) + 1], D = s[2 * (_ + (k + 1) * E)], R = s[2 * (_ + (k + 1) * E) + 1],
                F = p + 3 * c + G * g, b = f + 3 * d + G * y, x = p + 3 * c + Y * g, O = f + 3 * d + Y * y;
              B + U <= 1 ? (i[T] = C + (F - C) * B + (D - C) * U, i[T + 1] = N + (b - N) * B + (R - N) * U) : (i[T] = x + (D - x) * (1 - B) + (F - x) * (1 - U), i[T + 1] = O + (R - O) * (1 - B) + (b - O) * (1 - U))
            } else if (L <= 0) {
              (z = 0 | P) == _ && (z = _ - 1);
              var B = P - z, U = .5 * (L - -2), V = z / _, X = (z + 1) / _, D = s[2 * (z + 0 * E)],
                R = s[2 * (z + 0 * E) + 1], x = s[2 * (z + 1 + 0 * E)], O = s[2 * (z + 1 + 0 * E) + 1],
                C = p + V * c - 2 * g, N = f + V * d - 2 * y, F = p + X * c - 2 * g, b = f + X * d - 2 * y;
              B + U <= 1 ? (i[T] = C + (F - C) * B + (D - C) * U, i[T + 1] = N + (b - N) * B + (R - N) * U) : (i[T] = x + (D - x) * (1 - B) + (F - x) * (1 - U), i[T + 1] = O + (R - O) * (1 - B) + (b - O) * (1 - U))
            } else if (L >= 1) {
              var z = 0 | P;
              z == _ && (z = _ - 1);
              var B = P - z, U = .5 * (L - 1), V = z / _, X = (z + 1) / _, C = s[2 * (z + a * E)],
                ...
                D = p + V * c + 3 * g, R = f + V * d + 3 * y, x = p + X * c + 3 * g, O = f + X * d + 3 * y;
              B + U <= 1 ? (i[T] = C + (F - C) * B + (D - C) * U, i[T + 1] = N + (b - N) * B + (R - N) * U) : (i[T] = x + (D - x) * (1 - B) + (F - x) * (1 - U), i[T + 1] = O + (R - O) * (1 - B) + (b - O) * (1 - U))
        ...
        try {
          ...
          for (var h = e.length, l = t.width, $ = t.height, u = this.context, p = this._$xP, f = this._$uP, c = this._$6r, d = this._$3r, g = rt.tr, y = rt._$Ti, m = rt._$Pi, T = rt._$B, P = 0; P < h; P += 3) {
            ...
            var S = e[P], v = e[P + 1], L = e[P + 2], E = p + c * i[2 * S], M = f + d * i[2 * S + 1],
              I = p + c * i[2 * v], A = f + d * i[2 * v + 1], w = p + c * i[2 * L], x = f + d * i[2 * L + 1];
            s && (s._$PS(E, M, T), E = T[0], M = T[1], s._$PS(I, A, T), I = T[0], A = T[1], s._$PS(w, x, T), w = T[0], x = T[1]);
            var O = l * r[2 * S], D = $ - $ * r[2 * S + 1], R = l * r[2 * v], F = $ - $ * r[2 * v + 1],
              b = l * r[2 * L], C = $ - $ * r[2 * L + 1], N = Math.atan2(F - D, R - O), B = Math.atan2(A - M, I - E),
              U = I - E, G = A - M, Y = Math.sqrt(U * U + G * G), k = R - O, V = F - D,
              X = Y / Math.sqrt(k * k + V * V);
            Lt._$ni(b, C, O, D, R - O, F - D, -(F - D), R - O, y), Lt._$ni(w, x, E, M, I - E, A - M, -(A - M), I - E, m);
            var z = (m[0] - y[0]) / y[1], H = Math.min(O, R, b), W = Math.max(O, R, b), j = Math.min(D, F, C),
              q = Math.max(D, F, C), J = Math.floor(H), Q = Math.floor(j), Z = Math.ceil(W), K = Math.ceil(q);
        ...
        var l = s - o, $ = _ - n, u = a - o, p = h - n, f = l * p - $ * u > 0 ? i : -i, c = -$, d = l, g = a - s,
          y = h - _, m = -y, T = g, P = Math.sqrt(g * g + y * y), S = -p, v = u, L = Math.sqrt(u * u + p * p),
          E = o - f * c / r, M = n - f * d / r, I = s - f * c / r, A = _ - f * d / r, w = s - f * m / P,
          x = _ - f * T / P, O = a - f * m / P, D = h - f * T / P, R = o + f * S / L, F = n + f * v / L,
          b = a + f * S / L, C = h + f * v / L, N = rt._$50;
        ...
        t || (t = new ct);
        var e = this.m, i = e[0], r = e[1], o = e[2], n = e[3], s = e[4], _ = e[5], a = e[6], h = e[7], l = e[8],
            ...
            if (r.isTexLoaded) {
              if (r.modelSetting.getExpressionNum() > 0) {
                ...
                for (s = 0; s < r.modelSetting.getExpressionNum(); s++) {
                  var t = r.modelSetting.getExpressionName(s), e = r.modelHomeDir + r.modelSetting.getExpressionFile(s);
